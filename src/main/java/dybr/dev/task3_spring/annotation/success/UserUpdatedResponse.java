...
@ApiResponse(responseCode = "200", description = "Пользователь успешно изменён", content = @Content(mediaType = "application/prs.hal-forms+json", schema = @Schema(implementation = UserResponseDTO.class, example = """
        {
           "_links": {
             "self": {
